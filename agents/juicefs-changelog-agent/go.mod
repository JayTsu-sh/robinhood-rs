module github.com/JayTsu-sh/robinhood-rs/agents/juicefs-changelog-agent

go 1.25.0

// Dependency-module replace directives are not inherited by Go. Keep these in
// sync with the pinned JuiceFS tag so this agent builds the same implementation
// as the official v1.4.1 binary.
...
replace github.com/mattn/go-colorable => github.com/juicedata/go-colorable v0.0.0-20250208072043-a97a0c2023db
...
require (
	github.com/juicedata/juicefs v1.4.1
